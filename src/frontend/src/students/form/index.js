    ...
    <div className={classes.root}>
      ...
      >
        <Form className={classes.form}>
          <TextField id="name" name="name" label="Name" required></TextField>
          <TextField name="surname" label="Surname" required></TextField>
          <TextField
            name="accountName"
            label="Account name"
            disabled={!isNew}
          ...
          {!isNew && (
            <div>
              <Button onClick={toggleCourses} data-test-id="courses">
                Toggle courses
              </Button>
            </div>
          )}
          ...
          <div className={classes.actions}>
            <SubmitButton name="save" data-test-id="save" submitLabel="Submitting...">
              Save
            </SubmitButton>
            <Button
              variant="contained"
